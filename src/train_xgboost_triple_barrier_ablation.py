...
으로 바꿔서 비교. 대한제강은 기존 밸류에이션 ablation에서 가장 강했던 조합(AUC diff +0.0585)
...
전제:
    ...
    084010_features_triple_barrier_pt2sl1.csv, 084010_features_triple_barrier_pt2sl1_valuation.csv
    둘 다 생성돼 있어야 함.
"""
...
if __name__ == "__main__":
    df_base = load_dataset("084010", combined=False)
